...
static void user_tabview_init(void)
{
  ...
  lv_style_set_text_font(&style_tab, &arial_20);
  ...
  lv_style_set_text_font(&style_bg, &arial_20);
  ...
  lv_style_set_text_font(&style_fg, &arial_20);
...
static void tab6_create(lv_obj_t* parent)
{
  lv_example_meter_5(parent, -200, 0);
  lv_example_meter_5(parent, +200, 0);
...
static void user_test_button(lv_obj_t* parent, lv_coord_t x, lv_coord_t y, const char* symbol, const char* text)
{
  ...
  // lv_style_set_text_font(label, &arial_20);
