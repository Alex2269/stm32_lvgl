...
void sliders_horisontal(lv_obj_t* parent)
{
  ...
  lv_obj_set_size(slider1, LV_PCT(80), LV_PCT(2));
  lv_obj_set_size(slider2, LV_PCT(80), LV_PCT(2));
  lv_obj_set_size(slider3, LV_PCT(80), LV_PCT(2));
  lv_obj_set_size(slider4, LV_PCT(80), LV_PCT(4));

  // align
  lv_obj_align(slider1, LV_ALIGN_CENTER, 0, -90);
  lv_obj_align(slider2, LV_ALIGN_CENTER, 0, -30);
  lv_obj_align(slider3, LV_ALIGN_CENTER, 0, +30);
  lv_obj_align(slider4, LV_ALIGN_CENTER, 0, +90);
...
static void slider_event_cb(lv_event_t * e)
{
  ...
  if(slider1 == slider)
  {
    ...
    lv_obj_align_to(label1, slider, LV_ALIGN_CENTER, (value+200)-250, 16);
  }
  ...
  if(slider2 == slider)
  {
    ...
    lv_obj_align_to(label2, slider, LV_ALIGN_CENTER, (value+200)-250, 16);
  }
  ...
  if(slider3 == slider)
  {
    ...
    lv_obj_align_to(label3, slider, LV_ALIGN_CENTER, (value+200)-250, 16);
  }
  ...
  if(slider4 == slider)
  {
    ...
    lv_snprintf(buf, sizeof(buf), "%d%%  %d%%", left_value, value);
    printf("%d%%\n%d%%", value, left_value);
    lv_label_set_text(label4, buf);
    lv_obj_align_to(label4, slider, LV_ALIGN_CENTER, ((100+value+left_value) / 2 - 100), 0);
  }
}
