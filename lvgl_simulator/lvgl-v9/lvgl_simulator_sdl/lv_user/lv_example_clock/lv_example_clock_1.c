...
void lv_example_clock_1(lv_obj_t* parent)
{
  ...
  arc_create(meter1, &style_arc1, 330, 60,   0,360, LV_OPA_20, LV_PALETTE_ORANGE);
  arc_create(meter1, &style_arc2, 342,  4,   0,360, LV_OPA_80, LV_PALETTE_YELLOW);
  arc_create(meter1, &style_arc3, 350,  4,   0,360, LV_OPA_80, LV_PALETTE_LIME);
  arc_create(meter1, &style_arc4, 400, 28,   0, 90, LV_OPA_20, LV_PALETTE_ORANGE);
  arc_create(meter1, &style_arc5, 400, 28,  90,180, LV_OPA_40, LV_PALETTE_RED);
  arc_create(meter1, &style_arc6, 400, 28, 180,270, LV_OPA_60, LV_PALETTE_GREEN);
  arc_create(meter1, &style_arc7, 400, 28, 270,360, LV_OPA_40, LV_PALETTE_BLUE);
  //--draw arcs end--
