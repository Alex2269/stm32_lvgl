...
void lv_example_menu_5b(void)
{
    ...
    /*Create a root page*/
    root_page_1 = lv_menu_page_create(menu, "Settings");
    lv_obj_set_style_pad_hor(root_page_1, lv_obj_get_style_pad_left(lv_menu_get_main_header(menu), 0), 0);
    section = lv_menu_section_create(root_page_1);
    ...
    create_text(root_page_1, NULL, "Others", LV_MENU_ITEM_BUILDER_VARIANT_1);
    section = lv_menu_section_create(root_page_1);
    ...
    lv_menu_set_sidebar_page(menu, root_page_1);
...
static void switch_handler(lv_event_t * e)
{
    ...
    if(code == LV_EVENT_VALUE_CHANGED) {
        if(lv_obj_has_state(obj, LV_STATE_CHECKED)) {
            ...
            lv_menu_set_page(menu, root_page_1);
        }
    }
}
