...
static void mask_event_cb(lv_event_t * e)
{
    ...
    if (code == LV_EVENT_COVER_CHECK) {
        ...
        lv_draw_mask_fade_param_t * fade_mask_top = /*lv_mem_buf_get*/ malloc(sizeof(lv_draw_mask_fade_param_t));
        ...
        lv_draw_mask_fade_param_t * fade_mask_bottom = /*lv_mem_buf_get*/ malloc(sizeof(lv_draw_mask_fade_param_t));
        ...
        /*lv_mem_buf_release*/ free(fade_mask_top);
        /*lv_mem_buf_release*/ free(fade_mask_bottom);
        mask_top_id = -1;
        mask_bottom_id = -1;
    }
}
...
void lv_example_roller_4(lv_obj_t* parent, int16_t pos_x, int16_t pos_y)
{
    ...
    lv_style_set_text_font(&style, &arial_14);
