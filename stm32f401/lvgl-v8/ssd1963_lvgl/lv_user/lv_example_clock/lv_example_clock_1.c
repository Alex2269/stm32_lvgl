...
void lv_example_clock_1(lv_obj_t* parent)
{
  ...
  lv_style_set_text_font(&style_n1, &lv_font_montserrat_20);
  ...
  lv_style_set_text_font(&style_n2, &lv_font_montserrat_20);
  ...
  lv_style_set_text_font(&style_n3, &lv_font_montserrat_20);
