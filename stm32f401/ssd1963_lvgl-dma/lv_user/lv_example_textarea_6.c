...
void textarea_6(lv_obj_t* parent)
{
  ...
  lv_style_set_text_font(&style_ta, &lv_font_montserrat_28);
  ...
  lv_obj_set_style_text_font(ta1, &lv_font_montserrat_20, 0);
  ...
  lv_obj_set_style_text_font(ta2, &lv_font_montserrat_20, 0);
