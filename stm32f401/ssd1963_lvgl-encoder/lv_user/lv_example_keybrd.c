...
void lv_example_keybrd(lv_obj_t* parent)
{
  ...
  lv_style_set_text_font(&style_btns, &arial_20);
  ...
  // lv_obj_set_style_text_font(button_matrix, &arial_20, 0);
  lv_style_set_text_font(&style_btns, &arial_20);
  ...
  lv_style_set_text_font(&style_ta, &arial_20);
  ...
  // lv_style_set_text_font(&style_..., &arial_20);
  lv_obj_set_style_text_font(ta, &arial_20, 0);
